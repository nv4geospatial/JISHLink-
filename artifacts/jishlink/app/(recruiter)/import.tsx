  ...
  const pickFile = async () => {
    ...
    try {
      ...
      if (Platform.OS === "web") {
        ...
        // For native mobile, expo-file-system is required
        // Install with: npx expo install expo-file-system
        try {
          const FileSystem = await import("expo-file-system");
          const base64 = await FileSystem.readAsStringAsync(asset.uri, { encoding: "base64" });
          workbook = XLSX.read(base64, { type: "base64" });
        } catch (e) {
          Toast.show({ type: "error", text1: "File system not available. Please install expo-file-system for mobile support." });
          return;
        }
      }
