...
export default function AdminEditEmployeeScreen() {
  ...
  useEffect(() => {
    if (employee) {
      ...
      // Additional fields
      initialForm["dob"] = employee.dob ?? "";
      initialForm["gender"] = employee.gender ?? "";
      initialForm["blood_group"] = employee.blood_group ?? "";
      initialForm["qualification"] = employee.qualification ?? "";
      initialForm["marital_status"] = employee.marital_status ?? "";
      initialForm["date_of_joining"] = employee.date_of_joining ?? "";
      initialForm["recruiter_name"] = (employee as any).recruiter_name ?? "";
      ...
      setWorkplaceId(employee.workplace_id ?? "");
